...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> Reservations
                <small>Reservations tables</small>
            </h1>
            <ol class="breadcrumb">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        ...
                        <div class="box-footer">
                            <form method="post" action="{{route('reservation.archive')}}" id="reservationArchive">
                                {{csrf_field()}}
                                <input type="hidden" name="_method" value="PUT">
                                <button class="btn btn-block btn-warning">
                                    <i class="fa fa-archive fa-lg"></i> Archive
                                </button>
                            </form>
                        </div>
                    </div>
