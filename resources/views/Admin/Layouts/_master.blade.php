...
@if(Session::has('failure'))
    <div class="alert alert-danger alert-dismissable" style="border-radius: 0;">
...
@if(Session::has('success'))
    <div class="alert alert-success alert-dismissable" style="border-radius: 0;">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">
            &times;
        </button>
...
<div class="wrapper">
    <header class="main-header">
        <a href="" class="logo">
            ...
            <span class="logo-lg"><b>Admin</b>C-Panel</span>
        </a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="{{route('logout')}}" class="btn btn-default btn-flat">Signout</a>
                                </div>
                            </li>
                        </ul>
                    </li>
    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-cart-arrow-down"></i> <span>Reservation</span>
                        <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span>
                    </a>
                    <ul class="treeview-menu">
                        <li>
                            <a href="{{route('reservation.index')}}">
                                <i class="fa fa-cart-arrow-down"></i> Reservation
                            </a>
                        </li>
                        <li>
                            <a href="{{route('reservation.archive')}}">
