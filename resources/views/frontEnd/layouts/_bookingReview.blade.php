    ...
    <div class="booking-details">
        ...
        <div class="row booking-details-number">
            <div class="col-md-12">
                ...
                × {{translate('$').sprintf("%.2f",$price->st_price)}} {{translate('USD')}}
            </div>
            <div class="col-md-12">
                {{$data['sec_num']}} {{$item->price->sec_name}}
                × {{translate('$').sprintf("%.2f",$price->sec_price)}} {{translate('USD')}}
            </div>
        </div>
        <div class="row booking-details-total">
            <div class="col-md-12">
                <span>{{translate('Total')}}: {{translate('$').sprintf("%.2f",$total)}} {{translate('USD')}}</span>
